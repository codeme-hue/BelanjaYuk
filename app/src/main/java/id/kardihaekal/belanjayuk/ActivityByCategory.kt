...
import id.kardihaekal.belanjayuk.adapter.ProductAdapter
...
class ActivityByCategory : AppCompatActivity() {
    ...
    private fun getProduct(){
        ...
        var reques = JsonArrayRequest(Request.Method.GET, "http://192.168.1.5/store/apiproductid.php?cat_id="+GlobalData.idCategory, null, Response.Listener { response ->
